    ...
    <div id="wrapper">
        ...
        <nav>
            <ul class="main_menu">
                ...
                <li class="equipment is-sub is-current">
                    <a href="#">장비제어</a>
                    <ul class="sub_menu">
                        <li class="is-current"><router-link to = "/Equ01">장비제어</router-link></li>
        ...
        <div id="container">
            <section class="sales">
                ...
                <div class="contents">
                    <h2 class="title title_equ">장비제어</h2>
                    <span class="title_exp">화면에서 차단기 설정을 변경하신 후 [ 처리 ] 버튼을 누르셔야 완료 됩니다.</span>
